						...
						<div class="your-order">
							...
							<div class="your-order-body" style="padding: 0px 10px">
									...
									<!--  one item	 -->
										<div class="media">
											...
											<div class="media-body">
												...
												<span class="color-gray your-order-info">So luong: {{$product['qty']}}</span>
												<span class="color-gray your-order-info">Don gia: {{$product['item']['unit_price']}}</span>
											</div>
										</div>
									<!-- end one item -->
									@endforeach
								...
								<div class="your-order-item">
									...
									<div class="pull-right"><h5 class="color-black">{{(Session::has('cart'))
									?$totalPrice:"0"}}</h5></div>
									<div class="clearfix"></div>
								</div>
							</div>
